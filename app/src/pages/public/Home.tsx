...
// We will reuse reelThumb1 for demo purposes or use stone_art if appropriate, but reel format implies vertical. 
        ...
        <div className={styles.home}>
            ...
            <section className={styles.journeySection}>
                ...
                <div className={styles.degreesGrid}>
                    {/* Grado 1: Aprendiz */}
                    <div className={`${styles.degreeCard} fade-in-up`} style={{ animationDelay: '0.1s' }}>
                    ...
                    {/* Grado 2: Compañero */}
                    <div className={`${styles.degreeCard} fade-in-up`} style={{ animationDelay: '0.3s' }}>
                    ...
                    {/* Grado 3: Maestro */}
                    <div className={`${styles.degreeCard} fade-in-up`} style={{ animationDelay: '0.5s', borderTop: '4px solid var(--color-gold)' }}>
